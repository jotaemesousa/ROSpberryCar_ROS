...
{
    fd_ = 1;//open(dev_path.c_str(), O_RDWR);
...
void ROSpberryCar::send_twist_cmd(float linear_velocity, float angular_velocity, HBridgeDriveMode mode)
{
    ...
    new_linear_vel_ = ::map(linear_velocity, -MAX_LINEAR_VEL, MAX_LINEAR_VEL, -MAX_RAW_LINEAR_VEL, MAX_RAW_LINEAR_VEL);
    new_angular_vel_ = ::map(angular_velocity, -MAX_ANGULAR_VEL, MAX_ANGULAR_VEL, -MAX_RAW_ANGULAR_VEL, MAX_RAW_ANGULAR_VEL);
    new_mode_ = mode;
